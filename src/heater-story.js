import { createHeater } from './heater-model.js';
const scenes=[
['ريبون · RE-7-122','للشتاء.<br><em>حكاية أدفأ.</em>','اكتشف دفاية ريبون الكهربائية.','',1,0,.72,.12],
['01 / قوة الدفء','دفء تشعر به.<br><em>قوة تعتمد عليها.</em>','تدفئة بتقنية PTC بقدرة تصل إلى 2000 واط.','<b>2000</b> واط · تقنية PTC',1.17,3,1,.32],
['02 / أجواء اللهب','مشهد دافئ.<br><em>حتى قبل الدفء.</em>','تأثير لهب بصري يضيف أجواء المدفأة إلى لحظاتك.','تأثير لهب قابل للتشغيل والإيقاف',1.65,16,1.1,.55],
['03 / أوضاع الهواء','دفؤك.<br><em>على اختيارك.</em>','انتقل بين الهواء البارد والتدفئة المنخفضة والتدفئة العالية.','بارد &nbsp; / &nbsp; تدفئة منخفضة &nbsp; / &nbsp; تدفئة عالية',1.3,8,1,.26],
['04 / الوقت والتحكم','اضبطها.<br><em>واستمتع بلحظتك.</em>','ريموت للتحكم بالتشغيل وأوضاع الهواء والحرارة والمؤقت واللهب والرذاذ.','حتى <b>12</b> ساعة · مؤقت',1.45,10,1,.2],
['05 / الترطيب','لمسة إضافية.<br><em>لأجواء المكان.</em>','وظيفة رذاذ يمكن تشغيلها وإيقافها من زر اللهب بالضغط المطوّل لمدة ثانيتين.','املأ خزان الماء العلوي بما لا يزيد عن ثلاثة أرباعه.',1.22,7,1,.3],
